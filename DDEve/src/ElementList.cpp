...
ClassImp( ElementList ) ClassImp( ElementListContextMenu )
...
/// Copy constructor
ElementList::ElementList( const ElementList& l ) : TEveElementList( l ) {
  InstanceCount::increment( this );
}
...
/// Initializing constructor
ElementListContextMenu::ElementListContextMenu( Display* mgr ) : EveUserContextMenu( mgr ) {
