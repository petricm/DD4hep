...
int main( int argc, char** argv ) {
  ...
  std::cout << std::endl
            << " #######  materials between the two  points : " << p0 << "*cm  and " << p1 << "*cm :  " << std::endl;
  ...
  for ( unsigned i = 0, n = materials.size(); i < n; ++i ) {
    ...
    std::cout << "      " << mat << " thickness: " << length << " path_length:" << path_length
              << " integrated_X0: " << sum_x0 << " integrated_lambda: " << sum_lambda << std::endl;
  }
  ...
  std::cout << "     averaged Material : "
            << " Z: " << avMat.Z() << " A: " << avMat.A() << " densitiy: " << avMat.density()
            << " radiationLength: " << avMat.radiationLength() << " interactionLength: " << avMat.interactionLength()
            << std::endl
            << std::endl;
  ...
  std::cout << "     Integrated interaction lengths : " << path_length / avMat.interactionLength() << " lambda "
            << std::endl;
