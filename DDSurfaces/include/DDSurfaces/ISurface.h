...
namespace DDSurfaces {
  ...
  public:
    ...
    const Material& outerMaterial() const { return m_outerMaterial; }

    /// Sets the material in opposite direction of the normal
    void setInnerMaterial(const Material& material) { m_innerMaterial = material; }

    /// Sets the material in direction of the normal
    void setOuterMaterial(const Material& material) { m_outerMaterial = material; }

    /// Sets the nominal measurement directions
    void setMeasurement(const MeasurementDirections& measurement) { m_measurement = new MeasurementDirections(measurement); }
