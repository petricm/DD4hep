...
namespace DD4hep {
  ...
  struct GearZPlanarParameters : public gear::ZPlanarParametersImpl {
    ...
    GearZPlanarParameters(const Geometry::DetElement& d)
    ...
    GearZPlanarParameters(int type = ZPlanarParametersImpl::CMOS, double shellInnerRadius = 0., double shellOuterRadius = 0.,
                          double shellHalfLength = 0., double shellGap = 0., double shellRadLength = 0.)
        : gear::ZPlanarParametersImpl(type, shellInnerRadius, shellOuterRadius, shellHalfLength, shellGap, shellRadLength) {}
  };
}
