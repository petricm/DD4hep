...
template <>
bool Geant4GenericSD<Calorimeter>::buildHits( G4Step* step, G4TouchableHistory* ) {
  StepHandler           h( step );
...
template <>
class Geant4GenericSD<OpticalCalorimeter> : public Geant4GenericSD<Calorimeter> {
 public:
  /// Constructor. The sensitive detector element is identified by the detector name
  Geant4GenericSD( const string& nam, LCDD& lcdd_ref ) : Geant4GenericSD<Calorimeter>( nam, lcdd_ref ) {
  }
