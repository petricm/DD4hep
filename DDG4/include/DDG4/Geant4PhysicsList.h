...
namespace DD4hep {
  ...
  namespace Simulation {
    ...
    public:
      ...
      template <typename Q, typename T> void constructPhysics(Q* p, void (T::*f)(G4VModularPhysicsList*)) {
        m_physics.add(p, f);
      }
      /// Register process construction callback
      template <typename Q, typename T> void constructProcess(Q* p, void (T::*f)(G4VUserPhysicsList*)) {
        m_process.add(p, f);
      }
      /// Register particle construction callback
      template <typename Q, typename T> void constructParticle(Q* p, void (T::*f)(G4VUserPhysicsList*)) {
        m_particle.add(p, f);
      }
