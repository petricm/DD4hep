...
namespace DD4hep {
  ...
  namespace Simulation {
     ...
     * @version 1.0
     */
    class Geant4TrackPersistency : public Geant4GeneratorAction, public Geant4MonteCarloTruth {
    public:
    ...
    public:
      ...
      virtual const TrackEquivalents& equivalents() const {
        return m_equivalentTracks;
