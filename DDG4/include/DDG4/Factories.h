...
#define DECLARE_GEANT4SENSITIVEDETECTOR(name)         \
  ...
  PLUGINSVC_FACTORY_WITH_ID(name, std::string(#name), \
                            DD4hep::Simulation::Geant4SensitiveDetector*(std::string, DD4hep::Geometry::LCDD*))
...
#define DECLARE_GEANT4_SETUP(name, func)                                                                           \
  namespace DD4hep {                                                                                               \
    namespace Simulation {                                                                                         \
      ...
      template <>                                                                                                  \
      long Geant4SetupAction<xml_g4_setup_##name>::create(LCDD& l, const DD4hep::Simulation::Geant4Converter& e,   \
