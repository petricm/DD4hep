  ...
  namespace Simulation {
    ...
    public:
      ...
      public:
        ...
        /// Destructor
        ~ContextSwap() { action->updateContext(context); }
      };
    ...
    protected:
      ...
      public:
        ...
        /// Context updates
        void updateContext(Geant4Context* ctxt) { (*this)(&T::updateContext, ctxt); }
    ...
    public:
      ...
      virtual void updateContext(Geant4Context* ctxt) { m_context = ctxt; }
