...
namespace DD4hep {
  ...
  namespace Simulation {
    ...
    public:
      ...
      int hitCreationMode() const { return m_hitCreationMode; }
      ...
      SensitiveDetector sensitiveDetector() const { return m_sensitive; }
    ...
    public:
      ...
      template <typename HIT> size_t defineReadoutCollection(const std::string collection_name);
