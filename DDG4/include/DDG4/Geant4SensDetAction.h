...
class Geant4Sensitive : public Geant4Action {
 ...
 public:
  ...
  size_t defineCollection( const std::string& coll_name );
...
class Geant4SensDetActionSequence : public Geant4Action {
 ...
 public:
  ...
  template <typename TYPE>
  size_t defineCollection( Geant4Sensitive* owner, const std::string& coll_name ) {
...
/// Initialize the usage of a single hit collection. Returns the collection ID
template <typename TYPE>
inline size_t Geant4Sensitive::defineCollection( const std::string& coll_name ) {
 ...
 */
template <typename T>
class Geant4SensitiveAction : public Geant4Sensitive {
 public:
  typedef T UserData;
 ...
 public:
  ...
  Geant4SensitiveAction( Geant4Context* context, const std::string& name, Geometry::DetElement det,
                         Geometry::LCDD& lcdd );
  /// Default destructor
  ...
  size_t declareReadoutFilteredCollection();
