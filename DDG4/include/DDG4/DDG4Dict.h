...
#pragma link C++ function operator== ( const map < int, DD4hep::Simulation::Geant4Particle* > ::iterator&, \
                                       const map < int, DD4hep::Simulation::Geant4Particle* > ::iterator& );
#pragma link C++ function operator!= ( const map < int, DD4hep::Simulation::Geant4Particle* > ::iterator&, \
                                       const map < int, DD4hep::Simulation::Geant4Particle* > ::iterator& );
#endif
...
namespace Simulation {
#define NO_CALL \
  { throw "This function shoule never ever be called!"; }
/// Default constructor
...
/// Copy constructor
inline Geant4Particle::Geant4Particle( const Geant4Particle& ) {
  NO_CALL
}
/// Default destructor
inline Geant4Particle::~Geant4Particle() {
...
inline void Geant4Particle::removeDaughter( int ) {
  NO_CALL
}
/// Default constructor
...
inline Geant4HitData::Contribution Geant4HitData::extractContribution( const G4Step* ) {
  return Contribution();
}
/// Default constructor
...
/// Assignment operator
inline Geant4Tracker::Hit& Geant4Tracker::Hit::operator=( const Hit& ) {
  return *this;
}
/// Clear hit content
inline Geant4Tracker::Hit& Geant4Tracker::Hit::clear() {
  return *this;
}
/// Store Geant4 point and step information into tracker hit structure.
inline Geant4Tracker::Hit& Geant4Tracker::Hit::storePoint( const G4Step*, const G4StepPoint* ) {
  return *this;
}
/// Default constructor
