...
namespace DD4hep {
  ...
  namespace Simulation {
    ...
    public:
      ...
      /// Track's identifier
      int id() const { return track->GetTrackID(); }
      /// Track's parent identifier
      int parent() const { return track->GetParentID(); }
      ...
      const G4ThreeVector& vertex() const { return track->GetVertexPosition(); }
      /// Track global time
      double globalTime() const { return track->GetGlobalTime(); }
      /// Track proper time
      double properTime() const { return track->GetProperTime(); }
      /// Track's energy
      double energy() const { return track->GetTotalEnergy(); }
      /// Track's kinetic energy
      double kineticEnergy() const { return track->GetKineticEnergy(); }
      /// Track velocity
      ...
      const G4DynamicParticle* dynamic() const { return track->GetDynamicParticle(); }
