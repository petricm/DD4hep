...
namespace DD4hep {
  ...
  namespace Simulation {
    ...
    /// Overloaded -> operator to access particle details
    inline Geant4Particle* Geant4ParticleHandle::operator->() const { return particle; }
    /// Assignment operator
    ...
    /// Conversion  operator to pointer
    inline Geant4ParticleHandle::operator Geant4Particle*() const { return particle; }
    /// Accessor to the number of particle parents
    inline size_t Geant4ParticleHandle::numParent() const { return particle->parents.size(); }
    /// Accessor to the number of particle daughters
    inline size_t Geant4ParticleHandle::numDaughter() const { return particle->daughters.size(); }
    /// Access patricle momentum, energy as 4 vector
