...
namespace DD4hep {
  ...
  namespace Simulation {
    ...
    public:
      ...
      /// Access detector construcion action sequence (geometry+sensitives+field)
      Geant4DetectorConstructionSequence& detectorConstruction() { return *detectorConstruction(true); }
      ...
      /// Access to the user initialization object
      Geant4UserInitializationSequence& userInitialization() { return *userInitialization(true); }
    };
