...
Geant4RunAction::Geant4RunAction( Geant4Context* ctxt, const string& nam ) : Geant4Action( ctxt, nam ) {
...
/// Standard constructor
Geant4SharedRunAction::Geant4SharedRunAction( Geant4Context* ctxt, const string& nam ) : Geant4RunAction( ctxt, nam ) {
  InstanceCount::increment( this );
}
...
/// Standard constructor
Geant4RunActionSequence::Geant4RunActionSequence( Geant4Context* ctxt, const string& nam ) : Geant4Action( ctxt, nam ) {
  m_needsControl = true;
  InstanceCount::increment( this );
}
