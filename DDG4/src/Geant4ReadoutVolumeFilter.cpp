...
Geant4ReadoutVolumeFilter::Geant4ReadoutVolumeFilter( Geant4Context* ctxt, const std::string& nam, Readout ro,
  ...
  except( "+++ Custom collection name '%s' not defined in the Readout object: %s.", coll.c_str(), ro.name() );
}
