...
void Geant4ParticleGun::operator()( G4Event* event ) {
  ...
  print( "Shoot [%d] %.3f GeV %s pos:(%.3f %.3f %.3f)[mm] dir:(%6.3f %6.3f %6.3f)", m_shotNo, m_energy / CLHEP::GeV,
         m_particleName.c_str(), m_position.X() / CLHEP::mm, m_position.Y() / CLHEP::mm, m_position.Z() / CLHEP::mm,
