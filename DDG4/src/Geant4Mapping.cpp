...
Geant4Mapping::Geant4Mapping( LCDD& lcdd_ref ) : m_lcdd( lcdd_ref ), m_dataPtr( 0 ) {
}
...
Geant4VolumeManager Geant4Mapping::volumeManager() const {
  ...
  throw runtime_error(
      format( "Geant4Mapping", "Cannot create volume manager without Geant4 geometry info [Invalid-Info]" ) );
}
