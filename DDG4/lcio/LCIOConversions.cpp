 ...
 */
template <>
lcio::LCCollectionVec* Geant4DataConversion<lcio::LCCollectionVec, pair<const Geant4Context*, G4VHitsCollection*>,
 ...
 */
template <>
lcio::LCCollectionVec* Geant4DataConversion<lcio::LCCollectionVec, pair<const Geant4Context*, Geant4HitCollection*>,
  ...
  for ( size_t i = 0; i < nhits; ++i ) {
    ...
    lc_hit->setMomentum( hit->momentum.x() / CLHEP::GeV, hit->momentum.y() / CLHEP::GeV,
...
lcio::LCCollectionVec* Geant4DataConversion<lcio::LCCollectionVec, pair<const Geant4Context*, Geant4HitCollection*>,
  ...
  for ( size_t i = 0; i < nhits; ++i ) {
    ...
    float                         pos[ 3 ] = {float( hit->position.x() / mm ), float( hit->position.y() / mm ),
