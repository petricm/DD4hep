  ...
  namespace DDSegmentation {
    ...
    public:
      ...
      struct LayerDimensions {
        LayerDimensions(double _x = 1., double _y = 1.) : x(_x), y(_y) {}
        double x, y;
      };
      ...
      const std::string& identifierX() const { return _identifierX; }
      /// access the encoding field name used for Y
      const std::string& identifierY() const { return _identifierY; }
      /// access the encoding field name used for Y
      const std::string& identifierLayer() const { return _identifierLayer; }
      ...
      void setIdentifierX(const std::string& fieldName) { _identifierX = fieldName; }
      /// set the encoding field name used for Y
      void setIdentifierY(const std::string& fieldName) { _identifierY = fieldName; }
      /// set the encoding field name used for layer
      void setIdentifierLayer(const std::string& fieldName) { _identifierLayer = fieldName; }
