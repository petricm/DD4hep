  ...
  namespace DDSegmentation {
    ...
    public:
      ...
      struct LayerDimensions {
        LayerDimensions(double x = 1., double y = 1.) : x(x), y(y) {}
        double x, y;
      };
      ...
      void setIdentifierX(const std::string& name) { _identifierX = name; }
      /// set the encoding field name used for Y
      void setIdentifierY(const std::string& name) { _identifierY = name; }
      /// set the encoding field name used for layer
      void setIdentifierLayer(const std::string& name) { _identifierLayer = name; }
