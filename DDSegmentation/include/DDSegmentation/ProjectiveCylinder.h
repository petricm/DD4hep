...
namespace DD4hep {
  namespace DDSegmentation {
    ...
    public:
      ...
      /// access the number of bins in theta
      int phiBins() const { return _phiBins; }
      /// access the coordinate offset in theta
      double offsetTheta() const { return _offsetTheta; }
      /// access the coordinate offset in phi
      double offsetPhi() const { return _offsetPhi; }
      /// access the field name used for theta
      std::string fieldNameTheta() const { return _thetaID; }
      /// access the field name used for phi
      std::string fieldNamePhi() const { return _phiID; }
      ...
      void setFieldNameTheta(const std::string& fieldName) { _thetaID = fieldName; }
