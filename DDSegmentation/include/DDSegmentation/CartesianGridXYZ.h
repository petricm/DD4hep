...
namespace DD4hep {
  namespace DDSegmentation {
    ...
    public:
      ...
      CartesianGridXYZ(TYPE cellEncoding, double gridSizeX = 1., double gridSizeY = 1., double gridSizeZ = 1.,
      ...
      CartesianGridXYZ(BitField64* decoder, double gridSizeX = 1., double gridSizeY = 1., double gridSizeZ = 1.,
                       double offsetX = 0., double offsetY = 0., double offsetZ = 0., std::string xField = "x",
                       std::string yField = "y", std::string zField = "z");
      /// destructor
      ...
      void setFieldNameZ(std::string name) { _zId = name; }
