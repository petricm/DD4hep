...
namespace DD4hep {
  namespace DDSegmentation {
    ...
    public:
      ...
      int NStripsY() { return _nStripsY; }

      int NStripsX() { return _nStripsX; }

      int NMegaY() { return _nMegaY; }
      ...
      void setIsRegulatingEBU(int layer, int wafer, bool isRegulating) { _isRegulatingEBU[layer][wafer] = isRegulating; }

      /// set the coordinate offset in X
      void setWaferOffsetX(int layer, int wafer, double offset) { _waferOffsetX[layer][wafer] = offset; }
      /// set the coordinate offset in Y
      void setWaferOffsetY(int layer, int wafer, double offset) { _waferOffsetY[layer][wafer] = offset; }
