...
class PolarGridRPhi2 : public PolarGrid {
 public:
  ...
  /// @param rValues The boundaries of the segments in radius, the first value is the lower boundary of the first bin,
  ...
  /// @param phiValues The size in phi for each bin in R, this vector is one smaller than the vector for
  /// PolarGridRPhi2::setGridRValues
