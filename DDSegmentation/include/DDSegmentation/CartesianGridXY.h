...
namespace DD4hep {
  namespace DDSegmentation {
    ...
    public:
      ...
      CartesianGridXY(TYPE cellEncoding, double gridSizeX = 1., double gridSizeY = 1., double offsetX = 0.,
      ...
      double getGridSizeY() const { return _gridSizeY; }
      ...
      std::string getFieldNameY() const { return _yId; }
      ...
      void setFieldNameX(std::string name) { _xId = name; }
      /// set the field name used for Y
      void setFieldNameY(std::string name) { _yId = name; }
