...
namespace DD4hep {
  namespace DDSegmentation {
    ...
    public:
      ...
      /// Access to the parameter type
      std::string type() const { return TypeName<TYPE>::name(); }
