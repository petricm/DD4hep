  ...
  namespace DDSegmentation {
    ...
    public:
      ...
      SegmentationParameter(const std::string& name, const std::string& description, double& parameter,
          ...
          : _name(name), _description(description), _value(parameter), _defaultValue(defaultValue), _isOptional(isOptional) {
        _value = defaultValue;
      }
      /// Destructor
      ...
      const double& defaultValue() const { return _defaultValue; }
