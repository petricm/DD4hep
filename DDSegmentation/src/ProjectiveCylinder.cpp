...
ProjectiveCylinder::ProjectiveCylinder( const std::string& cellEncoding ) : CylindricalSegmentation( cellEncoding ) {
  ...
  registerParameter( "offset_theta", "Angular offset in theta", _offsetTheta, 0., SegmentationParameter::AngleUnit,
                     true );
...
CellID ProjectiveCylinder::cellID( const Vector3D& /* localPosition */, const Vector3D& globalPosition,
