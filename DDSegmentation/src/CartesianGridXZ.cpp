...
CartesianGridXZ::CartesianGridXZ( const std::string& cellEncoding ) : CartesianGrid( cellEncoding ) {
...
CartesianGridXZ::CartesianGridXZ( BitField64* decode ) : CartesianGrid( decode ) {
  // define type and description
  _type        = "CartesianGridXZ";
  _description = "Cartesian segmentation in the local XZ-plane";
...
CellID CartesianGridXZ::cellID( const Vector3D& localPosition, const Vector3D& /* globalPosition */,
