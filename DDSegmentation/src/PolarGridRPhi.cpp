...
PolarGridRPhi::PolarGridRPhi( const std::string& cellEncoding ) : PolarGrid( cellEncoding ) {
...
CellID PolarGridRPhi::cellID( const Vector3D& localPosition, const Vector3D& /* globalPosition */,
