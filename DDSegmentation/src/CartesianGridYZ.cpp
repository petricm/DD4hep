...
CartesianGridYZ::CartesianGridYZ( const std::string& cellEncoding ) : CartesianGrid( cellEncoding ) {
...
CellID CartesianGridYZ::cellID( const Vector3D& localPosition, const Vector3D& /* globalPosition */,
