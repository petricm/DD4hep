...
namespace DD4hep {
  namespace DDRec {
    ...
    public:
      ...
      /// Constructor to be used with an existing object
      VolSurface(const VolSurface& vsurf) : _surf(vsurf._surf) { ++_surf->_refCount; }
     ...
     * @version $Id$
     */
    template <class T> class VolSurfaceHandle : public VolSurface {
    public:
      VolSurfaceHandle(Geometry::Volume vol, SurfaceType typ, double thickness_inner, double thickness_outer, Vector3D u_val,
