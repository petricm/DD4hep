...
namespace DD4hep {
  namespace DDRec {
    ...
    public:
      Tracker(const Geometry::DetElement& det) : Geometry::DetElement(det) { getTrackerExtension(); }
    ...
    private:
      void getTrackerExtension() { _tracker = this->isValid() ? this->extension<TrackerExtension>() : 0; }
    };
