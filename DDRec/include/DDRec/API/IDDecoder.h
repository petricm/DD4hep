 ...
 */
    ...
    public:
      ...
      public:
        ...
        bool isBarrel() const { return value == Barrel; }

        bool isEndcap() const { return value == EndcapNorth || value == EndcapSouth; }

        bool isEndcapSouth() const { return value == EndcapSouth; }

        bool isEndcapNorth() const { return value == EndcapSouth; }

        BarrelEncapID getValue() const { return value; }
      ...
      static std::string barrelIdentifier() { return std::string("barrel"); }

      static std::string layerIdentifier() { return std::string("layer"); }

      static std::string systemIdentifier() { return std::string("system"); }
