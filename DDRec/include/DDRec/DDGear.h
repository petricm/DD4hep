...
class GearHandle {  //: public gear::GearParametersImpl {
 ...
 public:
  ...
  /** User c'tor - specify a name (should be the canonical name used in gear, eg. TPCParameters, SITParameters, etc.)
  and
  ...
  /** Name of GearParametersImpl object - should be the canonical name used in gear, eg. TPCParameters, SITParameters,
   * etc. */
