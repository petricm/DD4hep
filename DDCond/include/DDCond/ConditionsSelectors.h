...
class PoolInsert : public Cond__Oper {
  pool_type& pool;
...
class CollectionSelect : public Cond__Oper {
 ...
 public:
  ...
  void operator()( object_t* o ) const {
    coll.insert( coll.end(), o );
  }
  void operator()( const cond_t& o ) const {
    coll.insert( coll.end(), o.ptr() );
  }
  void operator()( const mapentry_t& o ) const {
    ( *this )( o.second.ptr() );
  }
 ...
 */
template <typename collection_type>
class ActiveSelect : public Cond__Oper {
 ...
 */
template <typename collection_type>
class KeyedSelect : public Cond__Oper {
  cond_t::key_type key;
  collection_type& collection;
