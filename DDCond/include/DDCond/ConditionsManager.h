...
namespace DD4hep {
  ...
  namespace Conditions {
    ...
    public:
      ...
      Condition get(const std::string& detector_path, const std::string& condition_name, const IOV& req_validity);

      /// Retrieve a condition given the conditions path = <Detector Element path>.<conditions name>
      Condition get(const std::string& conditions_path, const IOV& req_validity);

      /// Retrieve a condition given a Detector Element and the conditions name
      RangeConditions getRange(DetElement detector, const std::string& condition_name, const IOV& req_range_validity);

      /// Retrieve a condition given a Detector Element path and the conditions name
      RangeConditions getRange(const std::string& detector_path, const std::string& condition_name,
                               const IOV& req_range_validity);

      /// Retrieve a condition given the conditions path = <Detector Element path>.<conditions name>
      RangeConditions getRange(const std::string& conditions_path, const IOV& req_range_validity);
    };
