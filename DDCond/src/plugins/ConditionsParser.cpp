...
template <>
void Converter<iov>::operator()( xml_h seq ) const;
template <>
void Converter<include>::operator()( xml_h seq ) const;
template <>
void Converter<arbitrary>::operator()( xml_h seq ) const;
template <>
void Converter<conditions>::operator()( xml_h seq ) const;
}
 ...
 */
template <>
void Converter<iov>::operator()( xml_h element ) const {
  xml_dim_t e = element;
}
 ...
 */
template <>
void Converter<arbitrary>::operator()( xml_h e ) const {
  xml_comp_t elt( e );
  string     tag = elt.tag();
 ...
 */
template <>
void Converter<include>::operator()( xml_h element ) const {
 ...
 */
template <>
void Converter<conditions>::operator()( xml_h e ) const {
  ConversionArg* arg = _getArgs( param );
