...
class ConditionsXmlLoader : public ConditionsDataLoader {
  ...
  size_t load_source( const std::string& nam, key_type key, const iov_type& req_validity, RangeConditions& conditions );
 ...
 public:
  ...
  virtual size_t update( const iov_type& req_validity, RangeConditions& conditions, iov_type& iov_intersection );
};
...
size_t ConditionsXmlLoader::load_source( const std::string& nam, key_type key, const iov_type& req_validity,
...
size_t ConditionsXmlLoader::load( key_type key, const iov_type& req_validity, RangeConditions& conditions ) {
  size_t len = conditions.size();
...
size_t ConditionsXmlLoader::load_range( key_type key, const iov_type& req_validity, RangeConditions& conditions ) {
  size_t len = conditions.size();
