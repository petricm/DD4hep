 ...
 */
template <typename MAPPING, typename BASE>
class ConditionsMappedUpdatePool : public ConditionsMappedPool<MAPPING, BASE> {
  typedef typename ConditionsMappedPool<MAPPING, BASE>::key_type key_type;

 public:
  /// Default constructor
  ConditionsMappedUpdatePool( ConditionsManager mgr ) : ConditionsMappedPool<MAPPING, BASE>( mgr ) {
  }
