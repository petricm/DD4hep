...
std::pair<ConditionsDependencyCollection::iterator, bool> ConditionsDependencyCollection::insert(
...
std::pair<ConditionsDependencyCollection::iterator, bool> ConditionsDependencyCollection::insert( Dependency* dep ) {
  dep->addRef();
