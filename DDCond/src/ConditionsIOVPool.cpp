...
void ConditionsIOVPool::select( Condition::key_type key, const Condition::iov_type& req_validity,
...
void ConditionsIOVPool::selectRange( Condition::key_type key, const Condition::iov_type& req_validity,
                                     RangeConditions& result ) {
...
void ConditionsIOVPool::select( const Condition::iov_type& required_validity, RangeConditions& valid,
                                RangeConditions& expired, Condition::iov_type& conditions_validity ) {
  if ( !elements.empty() ) {
