...
class CaloEndcapPlaneImpl : public DD4hep::DDRec::VolPlaneImpl {
 ...
 public:
  ...
  CaloEndcapPlaneImpl( DDSurfaces::SurfaceType typ, double thickness_inner, double thickness_outer,
...
void Installer<UserData>::install( DetElement component, PlacedVolume pv ) {
  ...
  printout( DD4hep::INFO, "DD4hep_CaloFaceEndcapSurfacePlugin", "install tracking surfaces for :  %s ",
            component.name() );
  ...
  CaloEndcapPlane surf_pz( comp_vol, Type( Type::Helper, Type::Sensitive ), inner_thickness, outer_thickness, u, v, n,
                           o );
  ...
  CaloEndcapPlane surf_nz( comp_vol, Type( Type::Helper, Type::Sensitive ), inner_thickness, outer_thickness, u, v, n,
                           -1 * o );
