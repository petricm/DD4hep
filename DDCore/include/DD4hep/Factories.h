...
namespace {
  ...
  template <typename P>
  class Factory<P, TNamed*(DD4hep::Geometry::LCDD*, const DD4hep::XML::Handle_t*, DD4hep::Geometry::SensitiveDetector*)> {
  public:
    typedef DD4hep::Geometry::LCDD  LCDD;
    typedef DD4hep::XML::Handle_t   xml_h;
    typedef DD4hep::Geometry::Ref_t Ref_t;
...
#define DECLARE_XMLELEMENT(name, func)                                                         \
  namespace DD4hep {                                                                           \
    namespace Geometry {                                                                       \
      ...
      template <>                                                                              \
      DD4hep::Geometry::Ref_t XMLElementFactory<DD4hep::Geometry::xml_element_##name>::create( \
          DD4hep::Geometry::LCDD& l, const DD4hep::XML::Handle_t& e) {                         \
        return func(l, e);                                                                     \
      }                                                                                        \
    }                                                                                          \
  }                                                                                            \
...
#define DECLARE_DETELEMENT(name, func)                                                         \
  namespace DD4hep {                                                                           \
    namespace Geometry {                                                                       \
      ...
      template <>                                                                              \
      DD4hep::Geometry::Ref_t DetElementFactory<DD4hep::Geometry::det_element_##name>::create( \
          LCDD& l, const DD4hep::XML::Handle_t& e, SensitiveDetector& s) {                     \
        return func(l, e, s);                                                                  \
      }                                                                                        \
    }                                                                                          \
  }                                                                                            \
  PLUGINSVC_FACTORY_WITH_ID(                                                                   \
      ...
      TNamed*(DD4hep::Geometry::LCDD*, const DD4hep::XML::Handle_t*, DD4hep::Geometry::SensitiveDetector*))
...
#define DECLARE_SUBDETECTOR(name, func)                                                        \
  namespace DD4hep {                                                                           \
    namespace Geometry {                                                                       \
      ...
      template <>                                                                              \
      DD4hep::Geometry::Ref_t DetElementFactory<DD4hep::Geometry::det_element_##name>::create( \
          DD4hep::Geometry::LCDD& l, const DD4hep::XML::Handle_t& e, SensitiveDetector&) {     \
        return func(l, e);                                                                     \
      }                                                                                        \
    }                                                                                          \
  }                                                                                            \
