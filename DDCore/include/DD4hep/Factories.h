...
#define DECLARE_NAMED_DETELEMENT_FACTORY(n, x) \
  ...
  PLUGINSVC_FACTORY_WITH_ID(                   \
      x, std::string(#x), DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*, DD4hep::Geometry::Ref_t*))
...
#define DECLARE_XMLELEMENT(name, func)                                                                                     \
  ...
  PLUGINSVC_FACTORY_WITH_ID(xml_element_##name, std::string(#name),                                                        \
                            DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*))
...
#define DECLARE_XML_PROCESSOR_BASIC(name, func, deprecated)                                                                \
  ...
  PLUGINSVC_FACTORY_WITH_ID(                                                                                               \
      det_element_##name, std::string(#name),                                                                              \
