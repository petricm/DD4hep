...
namespace {
  ...
  DD4HEP_PLUGIN_FACTORY_ARGS_1(void*, const char*) { return DD4hep::ConstructionFactory<P>::create(a0); }

  DD4HEP_PLUGIN_FACTORY_ARGS_1(ns::Named*, ns::LCDD*) { return DD4hep::TranslationFactory<P>::create(*a0).ptr(); }
...
#define DECLARE_XML_PROCESSOR_BASIC(name, func, deprecated)                                                             \
  DD4HEP_OPEN_PLUGIN(DD4hep, det_element_##name) {                                                                      \
    ...
    DD4HEP_PLUGINSVC_FACTORY(det_element_##name, name, NamedObject*(Geometry::LCDD*, XML::Handle_t*, Geometry::Ref_t*), \
                             __LINE__)                                                                                  \
  }
