...
namespace {
  ...
  template <typename P>
  class Factory<P, DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*, DD4hep::Geometry::Ref_t*)> {
  public:
    typedef DD4hep::Geometry::LCDD  LCDD;
    typedef DD4hep::XML::Handle_t   xml_h;
    typedef DD4hep::Geometry::Ref_t Ref_t;
...
#define DECLARE_DETELEMENT_FACTORY(x) \
  DD4HEP_PLUGINSVC_FACTORY(           \
      x, x, DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*, DD4hep::Geometry::Ref_t*), __LINE__)
#define DECLARE_NAMESPACE_DETELEMENT_FACTORY(n, x) \
  DD4HEP_PLUGINSVC_FACTORY(                        \
      n::x, x, DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*, DD4hep::Geometry::Ref_t*), __LINE__)
...
#define DECLARE_XMLELEMENT(name, func)                                                                                      \
  namespace DD4hep {                                                                                                        \
    namespace Geometry {                                                                                                    \
      namespace {                                                                                                           \
        struct xml_element_##name {};                                                                                       \
      }                                                                                                                     \
      template <>                                                                                                           \
      DD4hep::Geometry::Ref_t XMLElementFactory<DD4hep::Geometry::xml_element_##name>::create(DD4hep::Geometry::LCDD& l,    \
  ...
  DD4HEP_PLUGINSVC_FACTORY(xml_element_##name, name, DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*), \
                           __LINE__)
...
#define DECLARE_XML_DOC_READER(name, func)                                                                                \
  namespace DD4hep {                                                                                                      \
    namespace Geometry {                                                                                                  \
      ...
      template <>                                                                                                         \
      long XMLDocumentReaderFactory<DD4hep::Geometry::xml_document_##name>::create(DD4hep::Geometry::LCDD& l,             \
                                                                                   DD4hep::XML::Handle_t   e) {           \
        return func(l, e);                                                                                                \
      }                                                                                                                   \
    }                                                                                                                     \
  ...
  DD4HEP_PLUGINSVC_FACTORY(xml_document_##name, name##_XML_reader, long(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*), \
                           __LINE__)

#define DECLARE_XML_PROCESSOR_BASIC(name, func, deprecated)                                                                 \
  namespace DD4hep {                                                                                                        \
    namespace Geometry {                                                                                                    \
      struct det_element_##name {};                                                                                         \
      template <>                                                                                                           \
      DD4hep::Geometry::Ref_t DetElementFactory<DD4hep::Geometry::det_element_##name>::create(DD4hep::Geometry::LCDD& l,    \
                                                                                              DD4hep::XML::Handle_t   e,    \
                                                                                              DD4hep::Geometry::Ref_t h) {  \
        if (deprecated)                                                                                                     \
  ...
  DD4HEP_PLUGINSVC_FACTORY(det_element_##name, name,                                                                        \
                           DD4hep::NamedObject*(DD4hep::Geometry::LCDD*, DD4hep::XML::Handle_t*, DD4hep::Geometry::Ref_t*), \
                           __LINE__)
