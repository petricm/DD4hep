...
class Alignment : public Handle<AlignmentData> {
 ...
 public:
  ...
  template <typename Q>
  Alignment( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
...
class AlignmentCondition : public Handle<Interna::AlignmentConditionObject> {
 ...
 public:
  ...
  /// Constructor to be used when reading the already parsed object
  template <typename Q>
  AlignmentCondition( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
  /// Object constructor for pure alignment objects
...
class Container : public Handle<Interna::AlignmentContainer> {
 ...
 public:
  ...
  /// Constructor to be used when reading the already parsed object
  template <typename Q>
  Container( const Container& c ) : Handle<Object>( c ) {
  }

  /// Constructor to be used when reading the already parsed object
  template <typename Q>
  Container( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
