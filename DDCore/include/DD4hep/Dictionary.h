...
#pragma link C++ function operator== (const std::map < std::string,                                  \
                                      DD4hep::Geometry::Handle < DD4hep::NamedObject >> ::iterator&, \
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== (const std::map < std::string, DD4hep::Geometry::DetElement > ::iterator&, \
                                      const std::map < std::string, DD4hep::Geometry::DetElement > ::iterator&);
#pragma link C++ function operator!= (const std::map < std::string, DD4hep::Geometry::DetElement > ::iterator&, \
                                      const std::map < std::string, DD4hep::Geometry::DetElement > ::iterator&);
#endif
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== (const std::map < std::string, std::string > ::iterator&, \
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== (const std::map < std::string, std::map < std::string, std::string >> ::iterator&, \
                                      const std::map < std::string, std::map < std::string, std::string >> ::iterator&);
#pragma link C++ function operator!= (const std::map < std::string, std::map < std::string, std::string >> ::iterator&, \
                                      const std::map < std::string, std::map < std::string, std::string >> ::iterator&);
#endif
