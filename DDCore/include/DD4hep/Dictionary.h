...
#pragma link C++ function operator== ( const map < string, DD4hep::Handle < DD4hep::NamedObject >> ::iterator&, \
                                       const map < string, DD4hep::Handle < DD4hep::NamedObject >> ::iterator& );
#pragma link C++ function operator!= ( const map < string, DD4hep::Handle < DD4hep::NamedObject >> ::iterator&, \
                                       const map < string, DD4hep::Handle < DD4hep::NamedObject >> ::iterator& );
#endif
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== ( const map < string, DD4hep::Geometry::DetElement > ::iterator&, \
                                       const map < string, DD4hep::Geometry::DetElement > ::iterator& );
#pragma link C++ function operator!= ( const map < string, DD4hep::Geometry::DetElement > ::iterator&, \
                                       const map < string, DD4hep::Geometry::DetElement > ::iterator& );
#endif
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== ( const map < string, string > ::iterator&, const map < string, \
                                       string > ::iterator& );
#pragma link C++ function operator!= ( const map < string, string > ::iterator&, const map < string, \
                                       string > ::iterator& );
#endif
...
#ifdef R__MACOSX
// We only need these declarations for the clang compiler
#pragma link C++ function operator== ( const map < string, map < string, string >> ::iterator&, const map < string, \
