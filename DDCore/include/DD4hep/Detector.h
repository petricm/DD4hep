...
namespace DD4hep {
  ...
  namespace Geometry {
    ...
    public:
      ...
      template <typename Q> static Q* createObject(const std::string& name, const std::string& type, int id) {
        DetElement det;
        Q*         p = new Q();
        Object*    o = p;
      ...
      /// Construction function for a new subdetector element
      template <typename Q> static DetElement create(const std::string& name, const std::string& type, int id, Q** ptr = 0) {
