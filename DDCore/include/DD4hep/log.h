...
#ifndef DD4HEP_DDCORE_LOG_H
#define DD4HEP_DDCORE_LOG_H
 ...
 */
#define IFLOG(level) if(dd4hep::LogLevel::level <= dd4hep::Log::getReportingLevel() && !dd4hep::Log::getStreams().empty())
 ...
 */
#define LOG(level)                                                                                                          \
    if(dd4hep::LogLevel::level <= dd4hep::Log::getReportingLevel() && !dd4hep::Log::getStreams().empty())                   \
    dd4hep::Log().getStream(                                                                                                \
        dd4hep::LogLevel::level, __FILE_NAME__, std::string(static_cast<const char*>(__func__)), __LINE__)
...
#define LOG_PROGRESS(level, identifier)                                                                                     \
    if(dd4hep::LogLevel::level <= dd4hep::Log::getReportingLevel() && !dd4hep::Log::getStreams().empty())                   \
    dd4hep::Log().getProcessStream(                                                                                         \
        identifier, dd4hep::LogLevel::level, __FILE_NAME__, std::string(static_cast<const char*>(__func__)), __LINE__)
