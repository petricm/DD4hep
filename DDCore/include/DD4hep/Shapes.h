 ...
 */
template <typename T>
class Solid_type : public Handle<T> {
 protected:
...
class Box : public Solid_type<TGeoBBox> {
 ...
 public:
  ...
  template <typename Q>
  Box( const Q* p ) : Solid_type<TGeoBBox>( p ) {
  }
  /// Constructor to be used with an existing object
  template <typename Q>
  Box( const Handle<Q>& e ) : Solid_type<TGeoBBox>( e ) {
  }
...
class HalfSpace : public Solid_type<TGeoHalfSpace> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  HalfSpace( const Q* p ) : Solid_type<TGeoHalfSpace>( p ) {
  }
  /// Constructor to be used with an existing object
  template <typename Q>
  HalfSpace( const Handle<Q>& e ) : Solid_type<TGeoHalfSpace>( e ) {
  }
...
class Polycone : public Solid_type<TGeoPcon> {
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Polycone( const Q* p ) : Solid_type<TGeoPcon>( p ) {
  }
  /// Constructor to be used when reading the already parsed polycone object
  template <typename Q>
  Polycone( const Handle<Q>& e ) : Solid_type<TGeoPcon>( e ) {
  }
...
class ConeSegment : public Solid_type<TGeoConeSeg> {
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  ConeSegment( const Q* p ) : Solid_type<TGeoConeSeg>( p ) {
  }
  /// Constructor to be used when reading the already parsed ConeSegment object
  template <typename Q>
  ConeSegment( const Handle<Q>& e ) : Solid_type<TGeoConeSeg>( e ) {
  }
...
class Tube : public Solid_type</*TGeoTubeSeg */ MyConeSeg> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Tube( const Q* p ) : Solid_type<MyConeSeg>( p ) {
  }
  /// Constructor to assign an object
  template <typename Q>
  Tube( const Handle<Q>& e ) : Solid_type<MyConeSeg>( e ) {
  }
...
class EllipticalTube : public Solid_type<TGeoEltu> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  EllipticalTube( const Q* p ) : Solid_type<TGeoEltu>( p ) {
  }
  /// Constructor to assign an object
  template <typename Q>
  EllipticalTube( const Handle<Q>& e ) : Solid_type<TGeoEltu>( e ) {
  }
  /// Constructor to create a new anonymous tube object with attribute initialization
...
class Cone : public Solid_type<TGeoCone> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Cone( const Q* p ) : Solid_type<TGeoCone>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Cone( const Handle<Q>& e ) : Solid_type<TGeoCone>( e ) {
  }
...
class Trap : public Solid_type<TGeoTrap> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Trap( const Q* p ) : Solid_type<TGeoTrap>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Trap( const Handle<Q>& e ) : Solid_type<TGeoTrap>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class Trapezoid : public Solid_type<TGeoTrd2> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Trapezoid( const Q* p ) : Solid_type<TGeoTrd2>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Trapezoid( const Handle<Q>& e ) : Solid_type<TGeoTrd2>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class Torus : public Solid_type<TGeoTorus> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Torus( const Q* p ) : Solid_type<TGeoTorus>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Torus( const Handle<Q>& e ) : Solid_type<TGeoTorus>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class Sphere : public Solid_type<TGeoSphere> {
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Sphere( const Q* p ) : Solid_type<TGeoSphere>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Sphere( const Handle<Q>& e ) : Solid_type<TGeoSphere>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class Paraboloid : public Solid_type<TGeoParaboloid> {
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Paraboloid( const Q* p ) : Solid_type<TGeoParaboloid>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Paraboloid( const Handle<Q>& e ) : Solid_type<TGeoParaboloid>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class Hyperboloid : public Solid_type<TGeoHype> {
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  Hyperboloid( const Q* p ) : Solid_type<TGeoHype>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  Hyperboloid( const Handle<Q>& e ) : Solid_type<TGeoHype>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class PolyhedraRegular : public Solid_type<TGeoPgon> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  PolyhedraRegular( const Q* p ) : Solid_type<TGeoPgon>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  PolyhedraRegular( const Handle<Q>& e ) : Solid_type<TGeoPgon>( e ) {
  }
...
class EightPointSolid : public Solid_type<TGeoArb8> {
 ...
 public:
  ...
  /// Constructor to be used with an existing object
  template <typename Q>
  EightPointSolid( const Q* p ) : Solid_type<TGeoArb8>( p ) {
  }
  /// Constructor to be used when passing an already created object
  template <typename Q>
  EightPointSolid( const Handle<Q>& e ) : Solid_type<TGeoArb8>( e ) {
  }
  /// Constructor to create a new anonymous object with attribute initialization
...
class SubtractionSolid : public BooleanSolid {
 public:
  ...
  /// Constructor to be used when passing an already created object
  template <typename Q>
  SubtractionSolid( const Handle<Q>& e ) : BooleanSolid( e ) {
  }
...
class UnionSolid : public BooleanSolid {
 public:
  ...
  /// Constructor to be used when passing an already created object
  template <typename Q>
  UnionSolid( const Handle<Q>& e ) : BooleanSolid( e ) {
  }
  /// Constructor to create a new object. Position is identity, Rotation is identity-rotation!
...
class IntersectionSolid : public BooleanSolid {
 public:
  ...
  /// Constructor to be used when passing an already created object
  template <typename Q>
  IntersectionSolid( const Handle<Q>& e ) : BooleanSolid( e ) {
  }
  /// Constructor to create a new object. Position is identity, Rotation is identity-rotation!
