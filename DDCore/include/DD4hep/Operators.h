...
class ByName {
 private:
  /// Assignment operator
  template <typename Q>
  ByName<T>& operator=( const ByName<Q>& /* copy */ ) {
    return *this;
  }
...
class ByNameAttr {
 private:
  /// Assignment operator
  template <typename Q>
  ByNameAttr<T>& operator=( const ByNameAttr<Q>& /* copy */ ) {
    return *this;
  }
...
ByNameAttr<T> byNameAttr( const std::string& nam ) {
  return ByNameAttr<T>( nam );
}
template <typename T>
ByNameAttr<T> byNameAttr( const T* o ) {
  return ByNameAttr<T>( o->name );
}
template <typename T>
ByNameAttr<T> byNameAttr( const T& o ) {
  return ByNameAttr<T>( o.name );
