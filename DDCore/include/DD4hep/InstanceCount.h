  ...
  namespace Geometry {
    ...
    public:
      ...
      public:
        ...
        /// Copy constructor
        Counter(const Counter& c) : m_count(c.m_count), m_tot(c.m_tot) {}
        /// Destructor
        ~Counter() {}
        /// Increment counter
        void increment() {
    ...
    public:
      ...
      template <class T> static void increment(T*) { getCounter(typeid(T))->increment(); }
      /// Decrement count according to type information
      template <class T> static void decrement(T*) { getCounter(typeid(T))->decrement(); }
      /// Access current counter
      template <class T> static counter_t get(T*) { return getCounter(typeid(T))->value(); }
      /// Increment count according to type information
      static void increment(const std::type_info& typ) { getCounter(typ)->increment(); }
      /// Decrement count according to type information
      static void decrement(const std::type_info& typ) { getCounter(typ)->decrement(); }
      /// Access current counter
      static counter_t get(const std::type_info& typ) { return getCounter(typ)->value(); }
      /// Increment count according to string information
      static void increment(const std::string& typ) { getCounter(typ)->increment(); }
      /// Decrement count according to string information
      static void decrement(const std::string& typ) { getCounter(typ)->decrement(); }
      /// Access current counter
      static counter_t get(const std::string& typ) { return getCounter(typ)->value(); }
