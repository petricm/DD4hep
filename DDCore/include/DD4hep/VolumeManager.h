...
namespace DD4hep {
  ...
  namespace Geometry {
    ...
    public:
      /// Default constructor
      VolumeManager() : Handle<VolumeManagerObject>() {}
      /// Constructor to be used when reading the already parsed object
      VolumeManager(const VolumeManager& e) : Handle<VolumeManagerObject>(e) {}
#ifndef __CINT__
      /// Constructor to be used when reading the already parsed object
      VolumeManager(const Handle<VolumeManagerObject>& e) : Handle<VolumeManagerObject>(e) {}
#endif
      /// Constructor to be used when reading the already parsed object
      template <typename Q> VolumeManager(const Handle<Q>& e) : Handle<VolumeManagerObject>(e) {}
