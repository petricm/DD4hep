...
class Header : public Handle<HeaderObject> {
 public:
  ...
  template <typename Q>
  Header( const Handle<Q>& e ) : Handle<HeaderObject>( e ) {
  }
...
class Constant : public Handle<ConstantObject> {
 public:
  ...
  /// Default constructor
  Constant() : Handle<ConstantObject>() {
  }
  /// Constructorto be used for assignment from a handle
  Constant( const Constant& e ) : Handle<ConstantObject>( e ) {
  }
  /// Constructor to be used when reading the already parsed DOM tree
  template <typename Q>
  Constant( const Handle<Q>& e ) : Handle<ConstantObject>( e ) {
  }
  /// Constructor to be used when creating a new DOM tree
...
class Atom : public Handle<TGeoElement> {
 public:
  ...
  template <typename Q>
  Atom( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
  /// Constructor to be used when reading the already parsed DOM tree
...
class Material : public Handle<TGeoMedium> {
 public:
  ...
  template <typename Q>
  Material( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
...
class VisAttr : public Handle<VisAttrObject> {
 public:
  ...
  template <typename Q>
  VisAttr( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
...
class LimitSet : public Handle<LimitSetObject> {
 public:
  ...
  /// Constructor to be used when reading the already parsed DOM tree
  template <typename Q>
  LimitSet( const Handle<Q>& e ) : Handle<LimitSetObject>( e ) {
  }
  /// Assignment operator
...
class Region : public Handle<RegionObject> {
 public:
  ...
  template <typename Q>
  Region( const Handle<Q>& e ) : Handle<Object>( e ) {
  }
  /// Constructor to be used when creating a new object
