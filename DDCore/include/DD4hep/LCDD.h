...
template <>
inline short LCDD::constant<short>( const std::string& name ) const {
  return (short)constantAsLong( name );
}

/// Typed access to constants: unsigned short values
template <>
inline unsigned short LCDD::constant<unsigned short>( const std::string& name ) const {
  return (unsigned short)constantAsLong( name );
}

/// Typed access to constants: integer values
template <>
inline int LCDD::constant<int>( const std::string& name ) const {
  return (int)constantAsLong( name );
}

/// Typed access to constants: unsigned integer values
template <>
inline unsigned int LCDD::constant<unsigned int>( const std::string& name ) const {
  return (unsigned int)constantAsLong( name );
}

/// Typed access to constants: long values
template <>
inline long LCDD::constant<long>( const std::string& name ) const {
  return constantAsLong( name );
}

/// Typed access to constants: unsigned long values
template <>
inline unsigned long LCDD::constant<unsigned long>( const std::string& name ) const {
  return (unsigned long)constantAsLong( name );
}

/// Typed access to constants: float values
template <>
inline float LCDD::constant<float>( const std::string& name ) const {
  return (float)constantAsDouble( name );
}

/// Typed access to constants: double values
template <>
inline double LCDD::constant<double>( const std::string& name ) const {
  return constantAsDouble( name );
}

/// Typed access to constants: string values
template <>
inline std::string LCDD::constant<std::string>( const std::string& name ) const {
