...
namespace DD4hep {
  ...
  namespace Conditions {
    ...
    public:
      ...
      /// Set data value
      void bind(const BasicGrammar* grammar, void (*ctor)(void*, const void*), void (*dtor)(void*));
      /// Set data value
    ...
    template <typename T> static void copyObject(void* t, const void* s) { *((T*)t) = *((const T*)s); }
