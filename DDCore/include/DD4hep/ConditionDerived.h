...
namespace DD4hep {
  ...
  namespace Conditions {
    ...
    struct ConditionUpdateContext {
      ...
      ConditionUpdateContext(const ConditionResolver& r, const ConditionDependency& d, void* parameter,
                             Condition::iov_type& iov);
      ...
      template <typename Q> Q* param() const { return static_cast<Q*>(parameter); }
    ...
    /// Initializing constructor
    inline ConditionUpdateContext::ConditionUpdateContext(const ConditionResolver& resolv, const ConditionDependency& dep,
                                                          void* user_param, Condition::iov_type& iov_ref)
        : resolver(resolv), dependency(dep), iov(&iov_ref), parameter(user_param) {}

    /// Access to dependency keys
    inline const ConditionKey& ConditionUpdateContext::key(size_t which) const { return dependency.dependencies[which]; }
