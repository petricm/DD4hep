...
class Handle {
 public:
  ...
  template <typename Q>
  Handle( Q* e ) : m_element( (T*)e ) {
    verifyObject();
  }
  /// Initializing constructor from unrelated handle with type checking
  template <typename Q>
  Handle( const Handle<Q>& e ) : m_element( (T*)e.m_element ) {
    verifyObject();
  }
  /// Assignment operator
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline char _multiply<char>( char left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline char _multiply<char>( const std::string& left, char right ) {
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned char _multiply<unsigned char>( unsigned char left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned char _multiply<unsigned char>( const std::string& left, unsigned char right ) {
  return _toInt( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline short _multiply<short>( short left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline short _multiply<short>( const std::string& left, short right ) {
  return _toInt( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned short _multiply<unsigned short>( unsigned short left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned short _multiply<unsigned short>( const std::string& left, unsigned short right ) {
  return _toInt( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline int _multiply<int>( int left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline int _multiply<int>( const std::string& left, int right ) {
  return _toInt( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned int _multiply<unsigned int>( unsigned int left, const std::string& right ) {
  return left * _toInt( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned int _multiply<unsigned int>( const std::string& left, unsigned int right ) {
  return _toInt( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline long _multiply<long>( long left, const std::string& right ) {
  return left * _toLong( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline long _multiply<long>( const std::string& left, long right ) {
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned long _multiply<unsigned long>( unsigned long left, const std::string& right ) {
  return left * _toLong( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline unsigned long _multiply<unsigned long>( const std::string& left, unsigned long right ) {
  return _toLong( left ) * right;
}
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline float _multiply<float>( float left, const std::string& right ) {
  return left * _toFloat( right );
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline float _multiply<float>( const std::string& left, float right ) {
...
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline double _multiply<double>( const std::string& left, double right ) {
  return _toDouble( left ) * right;
}
/// Generic multiplication using the evaluator: result = left * right  \ingroup DD4HEP_GEOMETRY
template <>
inline double _multiply<double>( double left, const std::string& right ) {
  return left * _toDouble( right );
}

/// Enter name value pair to the dictionary. \"value\" must be a numerical expression, which is evaluated  \ingroup
/// DD4HEP_GEOMETRY
