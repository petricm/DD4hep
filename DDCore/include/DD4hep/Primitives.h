...
namespace DD4hep {
  ...
  void typeinfoCheck(const std::type_info& typ1, const std::type_info& typ2,
                     const std::string& text = "") throw(std::exception);
  ...
  /// Throw exception when handles are check for validity
  template <typename T> void invalidHandleError() throw(std::exception) { invalidHandleError(typeid(T)); }
...
// Put here global basic type definitions derived from primitive types of the DD4hep namespace
  ...
  template <typename T> inline void destructObject(T* p) { p->~T(); }
  ...
  template <typename T> Select2nd<typename T::value_type> select2nd(const T&) { return Select2nd<typename T::value_type>(); }
  ...
  template <typename T> Select1st<typename T::value_type> select1st(const T&) { return Select1st<typename T::value_type>(); }
  ...
  public:
    void operator()(T& p) const { releasePtr(p); }
  };
  ...
  public:
    ...
    result_t operator()(const M& p) const { return ReferenceObject<result_t>()(p.second); }
  };
  template <typename M> ReferenceObject<M> referenceObject(M&) { return ReferenceObject<typename M::value_type>(); }
  ...
  template <typename C, typename R, typename T> void call_member_func(C& object, R (T::*pmf)()) {
    std::for_each(object.begin(), object.end(), ApplyMemFunc<R, T>(pmf));
  }

  template <typename C, typename R, typename T> void call_member_func(C& object, R (T::*pmf)() const) {
    std::for_each(object.begin(), object.end(), ApplyMemFuncConst<R, T>(pmf));
  }

  template <typename C, typename R, typename T, typename A1> void call_member_func(C& object, R (T::*pmf)(A1 a1), A1 a1) {
  ...
  public:
    ...
    void operator()(std::pair<typename M::key_type const, typename M::mapped_type>& p) const { (func)(p.first); }
    void operator()(const std::pair<typename M::key_type const, typename M::mapped_type>& p) const { (func)(p.first); }
  };
  ...
  template <typename C, typename R, typename T> void apply1rst(C& object, R (T::*pmf)()) {
    std::for_each(object.begin(), object.end(), apply__1rst_value(object, ApplyMemFunc<R, T>(pmf)));
  }

  template <typename C, typename R, typename T, typename A1> void apply1rst(C object, R (T::*pmf)(A1 a1), A1 a1) {
    std::for_each(object.begin(), object.end(), apply__1rst_value(object, ApplyMemFunc1<R, T, A1>(pmf, a1)));
  }

  template <typename C, typename R, typename T> void apply1rst(C& object, R (T::*pmf)() const) {
    std::for_each(object.begin(), object.end(), apply__1rst_value(object, ApplyMemFuncConst<R, T>(pmf)));
  }

  template <typename C, typename R, typename T, typename A1> void apply1rst(C object, R (T::*pmf)(A1 a1) const, A1 a1) {
  ...
  public:
    ...
    void operator()(std::pair<typename M::key_type const, typename M::mapped_type>& p) const { (func)(p.second); }
    void operator()(const std::pair<typename M::key_type const, typename M::mapped_type>& p) const { (func)(p.second); }
  };
  ...
  template <typename C, typename R, typename T> void apply2nd(C& object, R (T::*pmf)()) {
    std::for_each(object.begin(), object.end(), apply__2nd_value(object, ApplyMemFunc<R, T>(pmf)));
  }

  template <typename C, typename R, typename T, typename A1> void apply2nd(C object, R (T::*pmf)(A1 a1), A1 a1) {
    std::for_each(object.begin(), object.end(), apply__2nd_value(object, ApplyMemFunc1<R, T, A1>(pmf, a1)));
  }

  template <typename C, typename R, typename T> void apply2nd(C& object, R (T::*pmf)() const) {
    std::for_each(object.begin(), object.end(), apply__2nd_value(object, ApplyMemFuncConst<R, T>(pmf)));
  }

  template <typename C, typename R, typename T, typename A1> void apply2nd(C object, R (T::*pmf)(A1 a1) const, A1 a1) {
  ...
  public:
    ...
    bool isNull() const { return mask == 0; }
  };
  /// Standard constructor
