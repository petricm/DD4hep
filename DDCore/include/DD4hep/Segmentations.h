...
namespace DD4hep {
  ...
  namespace Geometry {
    ...
    public:
      ...
      long64 cellID(const DDSegmentation::Vector3D& localPosition, const DDSegmentation::Vector3D& globalPosition,
    ...
    public:
      ...
      Segmentation(const Handle<SegmentationObject>& e) : Handle<Object>(e) {}
#endif
