...
namespace DD4hep {
  ...
  namespace Geometry {
    ...
    public:
      ...
      template <typename T> Segmentation(T* o, const std::string& nam, const std::string& typ) : Handle<Implementation>() {
        o->segmentation = o;
        assign(o, nam, typ);
      }
      ...
      Segmentation(BaseSegmentation* s, const std::string& nam, const std::string& typ) : Handle<Implementation>() {
