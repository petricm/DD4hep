...
namespace DD4hep {
  namespace Geometry {
    ...
    struct Surface : public Ref_t {
      ...
      enum SurfaceType { Cylinder = 1, Plane, Other };
      ...
      struct Object : public TNamed {
        ...
        Object(Volume vol, SurfaceType type, bool isSensitive, double thickness_inner, double thickness_outer, Vector3D u,
               Vector3D v, Vector3D n, Vector3D o);
      ...
      Surface(Volume vol, SurfaceType type, bool isSensitive, double thickness_inner, double thickness_outer, Vector3D u,
