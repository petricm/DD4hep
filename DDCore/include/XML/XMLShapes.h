  ...
  */
  namespace XML {
    ...
    struct Cone : public Solid {
      ...
      /// Constructor to be used when creating a new DOM tree with attribute initialization
      Cone(const Document& doc, const XMLCh* name, double rmin1, double rmin2, double rmax1, double rmax2, double z,
    ...
    struct Trap : public Solid {
      ...
      /// Constructor to be used when creating a new DOM tree with attribute initialization
      Trap(const Document& doc, const XMLCh* name, double z, double theta, double phi, double y1, double x1, double x2,
