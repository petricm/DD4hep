...
namespace DD4hep {
  ...
  /// Initializing constructor
  inline LayerSlice::LayerSlice(bool s, double t, const std::string& m) : _sensitive(s), _thickness(t), _material(m) {}
  /// Copy constructor
  ...
  /// Copy constructor
  inline LayerStack::LayerStack(const LayerStack& c) : _layers(c._layers) {}
  ...
  namespace XML {
    ...
    /// Initializing constructor
    inline LayeringCnv::LayeringCnv(Element e) : Element(e) {}
  }
