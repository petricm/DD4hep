...
class Tag_t : public Strng_t {
 public:
  ...
  /// Copy constructor
  Tag_t( const Tag_t& c ) : Strng_t( c ), m_str( c.m_str ) {
  }
  /// Destructor
  ~Tag_t() {
  }
...
class Handle_t {
 public:
  ...
  unsigned int checksum( unsigned int param,
                         unsigned int( fcn )( unsigned int param, const XmlChar*, size_t ) = 0 ) const;
};
...
template <>
INLINE Attribute Handle_t::attr<Attribute>( const XmlChar* tag_value ) const {
  return attr_ptr( tag_value );
}

template <>
INLINE cpXmlChar Handle_t::attr<cpXmlChar>( const XmlChar* tag_value ) const {
  return attr_value( tag_value );
}

template <>
INLINE bool Handle_t::attr<bool>( const XmlChar* tag_value ) const {
  return _toBool( attr_value( tag_value ) );
}

template <>
INLINE int Handle_t::attr<int>( const XmlChar* tag_value ) const {
  return _toInt( attr_value( tag_value ) );
}

template <>
INLINE long Handle_t::attr<long>( const XmlChar* tag_value ) const {
  return _toLong( attr_value( tag_value ) );
}

template <>
INLINE float Handle_t::attr<float>( const XmlChar* tag_value ) const {
  return _toFloat( attr_value( tag_value ) );
}

template <>
INLINE double Handle_t::attr<double>( const XmlChar* tag_value ) const {
