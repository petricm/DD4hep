...
#define INLINE inline
    ...
    template <> INLINE Attribute Handle_t::attr<Attribute>(const XmlChar* tag) const { return attr_ptr(tag); }
    ...
    template <> INLINE float Handle_t::attr<float>(const XmlChar* tag) const { return _toFloat(attr_value(tag)); }
