  ...
  */
  namespace XML {
    ...
    struct Position : public XYZ_element {
      ...
      /// Constructor to be used when creating a new DOM tree
      Position(const Document& doc, const XMLCh* name) : XYZ_element(doc, Tag_position, name) {}
      /// Constructor to be used when creating a new DOM tree. Automatically sets attributes
    ...
    struct Rotation : public XYZ_element {
      ...
      /// Constructor to be used when creating a new DOM tree
      Rotation(const Document& doc, const XMLCh* name) : XYZ_element(doc, Tag_rotation, name) {}
      /// Constructor to be used when creating a new DOM tree. Automatically sets attributes
