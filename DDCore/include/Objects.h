  ...
  */
  namespace Geometry {
    ...
    struct Matrix : public RefElement {
      ...
      /// Constructor to be used when creating a new DOM tree
      Matrix(const Document& doc, const std::string& type, const std::string& name) : RefElement(doc, type, name) {}
    };
    ...
    struct Position : public Matrix {
      ...
      /// Constructor to be used when creating a new DOM tree
      Position(const Document& doc, const std::string& name) : Matrix(doc, "position", name) {}
    ...
    struct Rotation : public Matrix {
      ...
      /// Constructor to be used when creating a new DOM tree
      Rotation(const Document& doc, const std::string& name) : Matrix(doc, "rotation", name) {}
      /// Constructor to be used when creating a new DOM tree. Automatically sets attributes
    ...
    struct VisAttr : public RefElement {
      ...
      enum DrawingStyle { WIREFRAME = 0x1, LAST_DRAWING_STYLE };
