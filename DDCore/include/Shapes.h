  ...
  namespace Geometry {
    ...
    */
    ...
    struct Box : public Solid {
      ...
      Box(const Document& doc, const std::string& name, const X& x, const Y& y, const Z& z) : Solid(doc, "box", name) {
    ...
    struct Polycone : public Solid {
      ...
      Polycone(const Document& doc, const std::string& name, double start, double delta, const std::vector<double>& rmin,
...
/// Constructor to be used when creating a new tube object with attribute initialization
    ...
    struct Cone : public Solid {
      ...
      Cone(const Document& doc, const std::string& name, double z, double rmin1, double rmax1, double rmin2, double rmax2);
      template <typename Z, typename RMIN1, typename RMAX1, typename RMIN2, typename RMAX2>
      Cone(const Document& doc, const std::string& name, const Z& z, const RMIN1& rmin1, const RMAX1& rmax1,
           const RMIN2& rmin2, const RMAX2& rmax2)
          : Solid(doc, "Cone", name) {
    ...
    struct Trap : public Solid {
      ...
      /// Constructor to be used when creating a new object with attribute initialization
      Trap(const Document& doc, const std::string& name, double z, double theta, double phi, double y1, double x1, double x2,
