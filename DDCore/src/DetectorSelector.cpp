...
const DetectorSelector::Result& DetectorSelector::detectors( const string& type ) {
  return lcdd.detectors( type );
}

/// Access a set of subdetectors according to several sensitive types.
DetectorSelector::Result DetectorSelector::detectors( const string& type1, const string& type2, const string& type3,
 ...
 */
DetectorSelector::Result DetectorSelector::detectors( unsigned int includeFlag, unsigned int excludeFlag ) const {
  Result                 result;
