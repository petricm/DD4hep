...
auto CartesianGridXY::position(const CellID& cID) const -> Vector3D {
...
/// determine the cell ID based on the position
  auto CartesianGridXY::cellID(const Vector3D& localPosition, const Vector3D& /* globalPosition */, const VolumeID& vID) const -> CellID {
        CellID cID = vID ;
...
auto CartesianGridXY::cellDimensions(const CellID&) const -> std::vector<double> {
