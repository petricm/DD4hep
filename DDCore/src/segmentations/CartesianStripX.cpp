...
auto CartesianStripX::position(const CellID& cID) const -> Vector3D {
...
auto CartesianStripX::cellID(const Vector3D& localPosition, const Vector3D& /* globalPosition */,
...
auto CartesianStripX::cellDimensions(const CellID&) const -> std::vector<double> {
