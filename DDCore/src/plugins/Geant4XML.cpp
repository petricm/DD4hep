...
namespace DD4hep {
template <>
void Converter<Geant4>::operator()( xml_h e ) const;
template <>
void Converter<Geometry::GdmlFile>::operator()( xml_h e ) const;
template <>
void Converter<Geometry::Property>::operator()( xml_h e ) const;
template <>
void Converter<Geometry::SensitiveDetector>::operator()( xml_h e ) const;
}

template <>
void Converter<Geant4>::operator()( xml_h element ) const {
  ...
  xml_coll_t( compact, _U( sensitive_detectors ) )
      .for_each( _U( sd ), Converter<Geometry::SensitiveDetector>( lcdd, param ) );
}
