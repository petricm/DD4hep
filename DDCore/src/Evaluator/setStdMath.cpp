...
static double eval_fabs( double a ) {
  return std::fabs( a );
}
static double eval_fmod( double a, double b ) {
  return std::fmod( a, b );
}
...
static double eval_cbrt( double a ) {
  return ::cbrt( a );
}
...
static double eval_exp2( double a ) {
  return ::exp2( a );
}
// static double eval_exp10(double a)           { return ::exp10(a);              }
static double eval_exp10( double a ) {
  return ::pow( 10., a );
}
static double eval_expm1( double a ) {
  return ::expm1( a );
}
static double eval_log( double a ) {
  return std::log( a );
}
static double eval_logb( double a ) {
  return ::logb( a );
}
static double eval_log10( double a ) {
  return std::log10( a );
}
static double eval_log1p( double a ) {
  return ::log1p( a );
}
static double eval_hypot( double a, double b ) {
  return ::hypot( a, b );
}
static double eval_erf( double a ) {
  return ::erf( a );
}
static double eval_erfc( double a ) {
  return ::erfc( a );
}
static double eval_gamma( double a ) {
  return ::gamma( a );
}
static double eval_double( double a ) {
  return a;
}
static double eval_int( double a ) {
  return (double)int( a );
}
static double eval_nint( double a ) {
  return std::floor( a );
}
static double eval_floor( double a ) {
  return std::floor( a );
}
static double eval_round( double a ) {
  return ::round( a );
}
static double eval_ceil( double a ) {
  return std::ceil( a );
}
static double eval_isnan( double a ) {
  return std::isnan( a );
}
static double eval_isinf( double a ) {
  return std::isinf( a );
}
static double eval_nearbyint( double a ) {
  return ::nearbyint( a );
}
