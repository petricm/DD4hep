...
VisAttrObject::VisAttrObject()
    : magic( magic_word() ),
      ...
      color( 0 ),
      alpha( 0 ),
      drawingStyle( VisAttr::SOLID ),
      lineStyle( VisAttr::SOLID ),
      showDaughters( true ),
      visible( true ) {
...
/// Standard constructor
HeaderObject::HeaderObject() : NamedObject() {
  InstanceCount::increment( this );
}
...
/// Standard constructor
RegionObject::RegionObject() : magic( magic_word() ), threshold( 10.0 ), cut( 10.0 ), store_secondaries( false ) {
  InstanceCount::increment( this );
}
...
/// Standard constructor
IDDescriptorObject::IDDescriptorObject() : NamedObject(), BitField64() /*, maxBit(0) */ {
  InstanceCount::increment( this );
}

/// Standard constructor
IDDescriptorObject::IDDescriptorObject( const std::string& desc ) : NamedObject(), BitField64( desc ) /*, maxBit(0) */ {
  InstanceCount::increment( this );
}
