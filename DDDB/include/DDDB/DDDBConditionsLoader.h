...
namespace DD4hep {
  ...
  namespace DDDB {
    ...
    public:
      ...
      virtual size_t load(Geometry::DetElement det, const std::string& cond, const Conditions::IOV& req_validity,
                          Conditions::RangeConditions& conditions);
      /// Load  a condition set given a Detector Element and the conditions name according to their validity
      virtual size_t load_range(Geometry::DetElement det, const std::string& cond, const Conditions::IOV& req_validity,
                                Conditions::RangeConditions& conditions);
      /// Update a range of conditions according to the required IOV
      virtual size_t update(const Conditions::IOV& req_validity, Conditions::RangeConditions& conditions,
