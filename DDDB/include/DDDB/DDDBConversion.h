...
class PhysVol : public Named {
 public:
  enum { PHYSVOL_REGULAR = 1, PHYSVOL_PARAM1D = 2, PHYSVOL_PARAM2D = 3, PHYSVOL_PARAM3D = 4 };
  int         type;
...
class ParamPhysVol : public PhysVol {
 public:
  ...
  Transform3D trafo1;
  /// Default constructor
  ParamPhysVol() : PhysVol(), number1( 0 ) {
    type = PHYSVOL_PARAM1D;
  }
  /// Copy constructor
...
class ParamPhysVol2D : public ParamPhysVol {
 public:
  ...
  Transform3D trafo2;
  /// Default constructor
  ParamPhysVol2D() : ParamPhysVol(), number2( 0 ), trafo2() {
    type = PHYSVOL_PARAM2D;
  }
};
...
class ParamPhysVol3D : public ParamPhysVol2D {
 public:
  ...
  Transform3D trafo3;
  /// Default constructor
  ParamPhysVol3D() : ParamPhysVol2D(), number3( 0 ), trafo3() {
    type = PHYSVOL_PARAM3D;
  }
};
...
template <typename T>
void dddb_print( const T* object );
