...
template <>
void Converter<dddb_vis>::operator()( xml_h element ) const;
template <>
void Converter<vis>::operator()( xml_h element ) const;
template <>
void Converter<display>::operator()( xml_h element ) const;
template <>
void Converter<volume>::operator()( xml_h element ) const;
template <>
...
template <>
void Converter<dddb_vis>::operator()( xml_h e ) const {
